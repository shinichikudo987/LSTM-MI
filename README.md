...
Follow the instruction, you can reimplement our method. Besides, we also provide some dataset:

- The real-world collected datasets of some DGA botnet including Shifu, Tinba, Necurs, Locky, etc (in real data folder).
